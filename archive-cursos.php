...
<div class="container pt-4 pb-5">
    ...
    <h2 class="text-center pb-1" style="font-family: Raleway, sans-serif; font-weight: 700; font-size: 29px!important;">¿Qué quieres aprender hoy?</h2>    
                    ...
                    <div class="col pb-5">
                        <div class="card h-100 border-0 shadow">
                            ...
                            <div class="card-body pt-0">  
                                ...
                                <h2 class="card-title pt-2" style="line-height: 0.6;">
                                ...
                                <p class="card-text text-muted lh-sm">
                                    <small><?php echo esc_html(get_post_meta(get_the_ID(), 'oregoom_descrip_min_curso', true)); ?></small>
                                </p>

                                <p class="card-text"><small class="text-muted"><span class="badge bg-light text-dark"><?php   
                            ...
                            <div class="card-footer border-0 d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-dark">Por: <a href="<?php echo the_author_meta('url'); ?>" class="text-muted text-decoration-none" target="_blank"><?php the_author(); ?></a></small>
                            </div>
                        </div>
                    </div><?php
